      ...
      <div >
        ...
        <div className='flex flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row mt-14 items-center justify-center gap-10 md:gap-10'>
          ...
          <div className=' block bg-[#1D1C1F] rounded-xl px-6 py-6 w-[250px] h-[480px] md:w-[330px] md:h-[540px]'>
            ...
            < div className=' divst-none font-normal   mt-[30px] ml-[10px] text-[16px] md:text-[18px] xl:text-[18px] text-start text-[#F5F5F7] '>
              <div className='flex flex-row'>
              < div className='  mt-0 md:mt-6 '>
                <SiSpringboot className='text-[50px] md:text-[50px]  text-[#72B444] bg-[#f9f9f9] rounded-lg  shadow-sm shadow-[#f2f2f2] ml-0 md:ml-5' />
                Spring Boot
              </ div>
              < div className=' ml-0 md:ml-10 text-center justify-center '>
                <RiDatabase2Fill className='text-[50px] md:text-[60px] text-[#72B444] bg-[#f9f9f9] rounded-lg  shadow-sm shadow-[#f2f2f2] ml-9' />
                Spring Data JPA
              </ div>
              </div>
             
              < div className='ml-3 md:ml-7 mt-5 '>
                <Image
                  src={rest_icon}
                  alt={"STS"}
                  className='w-[50px] bg-[#f9f9f9] rounded-lg  shadow-sm shadow-[#f2f2f2] ml-[52px] md:ml-[60px]' />
                Restful Web Services</ div>
                <div className='flex flex-row '>
              < div className=' justify-center  text-center mt-2 md:mt-5'>
                <FaReact className='text-[50px] md:text-[56px] text-[#67DBFA] bg-[#2f2f2f] rounded-lg  shadow-sm shadow-[#f2f2f2] ml-2' />
                React JS</ div>
                
              < div className='ml-12 md:ml-20 mt-4 md:mt-12  text-center '>
                <FaAws className='text-[50px] md:text-[50px] text-[#ff893a] bg-[#f9f9f9] rounded-lg shadow-sm shadow-[#f2f2f2] ml-5' />
                AWS(Basics)</ div>
                </div>
          ...
          <div className=' block  bg-[rgb(218,242,233)] rounded-xl p-6 w-[250px] h-[480px] md:w-[330px] md:h-[540px]'>
            ...
            < div className=' divst-none font-normal   gap-y-[30px] mt-8 ml-[10px] text-[16px] md:text-[18px] xl:text-[18px] text-[#434343] '>
              ...
              < div className='pl-0 md:pl-12 '>
                <FaGithub className='text-[50px] md:text-[60px] text-[#000] bg-[#f9f9f9] rounded-lg shadow-sm shadow-[#272727]' />
                GitHub</ div>
              ...
              < div className=' mt-5 text-center justify-center'>
                <SiSpring className='text-[50px] md:text-[55px] text-[#72B444] bg-[#f2f2f2] rounded-lg shadow-sm shadow-[#272727]' />
                STS</ div>
              < div className='  pl-20 mt-16 text-center'>
                <SiPostman className='text-[50px] md:text-[60px] text-[#FE7041] bg-[#f9f9f9] rounded-lg shadow-sm shadow-[#272727] ml-1' />
                Postman</ div>
                </div>
